...
class AbogadoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('administracion.abogado.index', compact('abogados'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->back()->with('error', 'Ocurrió un error al crear el abogado: ' . $e->getMessage());
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::rollBack();
            return redirect()->back()->with('error', 'Ocurrió un error al actualizar el abogado: ' . $e->getMessage());
        }
    }
